...
LEFT JOIN Oregon_Reporting.prodcopy.TM_Transaction__c pctt WITH (NOLOCK) ON pctt.FactTicketSalesID__c = t.FactTicketSalesID__c --updateme for TM_Transaction (only because Oregon had both Pac and TM)
